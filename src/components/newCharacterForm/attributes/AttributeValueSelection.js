...
export const AttributeValueSelection = ( {newAttributeId, newAttributeValue, attributeDependencyMatrix, setAttributeDependencyMatrix, setNewAttributes, characterAttributes, setCharacterAttributes, allAttributeNames} ) => {
    return <>
